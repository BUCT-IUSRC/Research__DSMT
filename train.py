...
#-----------------------------------------------------------------------------------------------------------                         
        ...
        if rank in [-1, 0]:
            ...
            if epoch % 10 == 0 or (epochs - epoch) < 40:
                mIoU = test.seg_validation(model=ema.ema, valloader=seg_valloader, device=device, n_segcls=5,
                                half_precision=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='best_239.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='mtm_pdlk.yaml', help='model.yaml path')
